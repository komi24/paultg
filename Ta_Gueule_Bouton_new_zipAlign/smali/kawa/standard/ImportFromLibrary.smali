...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v2, "gnu.kawa.slib.srfi1"
    ...
    const-string/jumbo v2, "and-let*"

    aput-object v2, v1, v5

    const-string/jumbo v2, "gnu.kawa.slib.srfi2"
    ...
    const-string/jumbo v2, "basic-string-ports"
    ...
    const-string/jumbo v3, "let-values"
    ...
    const-string/jumbo v3, "gnu.kawa.slib.srfi13"
    ...
    const-string/jumbo v3, "char-sets"
    ...
    const-string/jumbo v3, "case-lambda"
    ...
    const-string/jumbo v3, "generalized-set!"
    ...
    const-string/jumbo v3, "multithreading"
    ...
    const-string/jumbo v3, "real-time-multithreading"
    ...
    const-string/jumbo v3, "multi-dimensional-arrays"
    ...
    const-string/jumbo v3, "random-bits"
    ...
    const-string/jumbo v3, "basic-format-strings"
    ...
    const-string/jumbo v3, "localization"
    ...
    const-string/jumbo v3, "with-shared-structure"
    ...
    const-string/jumbo v3, "eager-comprehensions"
    ...
    const-string/jumbo v3, "syntax-rules"
    ...
    const-string/jumbo v3, "intermediate-format-strings"
    ...
    const-string/jumbo v3, "rest-values"
    ...
    const-string/jumbo v3, "vicinities"
    ...
    const-string/jumbo v3, "integer-bits"
    ...
    const-string/jumbo v3, "gnu.kawa.slib.testing"
    ...
    const-string/jumbo v3, "66"

    aput-object v3, v2, v4

    const-string/jumbo v3, "octet-vectors"
    ...
    const-string/jumbo v3, "compare-procedures"
    ...
    const-string/jumbo v3, "69"

    aput-object v3, v2, v4

    const-string/jumbo v3, "basic-hash-tables"

    aput-object v3, v2, v5

    const-string/jumbo v3, "gnu.kawa.slib.srfi69"
    ...
    const-string/jumbo v3, "lightweight-testing"
    ...
    const-string/jumbo v3, "mu-and-nu"
    ...
    const-string/jumbo v3, "sorting-and-merging"

    aput-object v3, v2, v5

    const-string/jumbo v3, "kawa.lib.srfi95"
...
.method public constructor <init>()V
    ...
    const-string/jumbo v2, "kawa.lib."
...
.method public scanForDefinitions(Lgnu/lists/Pair;Ljava/util/Vector;Lgnu/expr/ScopeExp;Lkawa/lang/Translator;)Z
    ...
    const-string/jumbo v5, "expected <library reference> which must be a list"
    ...
    const-string/jumbo v6, "duplicate version reference - was "
    ...
    const-string/jumbo v6, "import version "
    ...
    const-string/jumbo v5, "source specifier must be last elemnt in library reference"
    ...
    const-string/jumbo v6, "malformed URL: "
    ...
    const-string/jumbo v5, "SRFI library reference must have the form: (srfi :NNN [name])"
    ...
    const-string/jumbo v6, "unknown SRFI number \'"
    ...
    const-string/jumbo v6, "\' in SRFI library reference"
    ...
    const-string/jumbo v6, "the name of SRFI "
    ...
    const-string/jumbo v6, "sorry - Kawa does not support SRFI "
