...
.method static bad_option(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "kawa: bad option \'"
...
.method static checkInitFile()V
    ...
    const-string/jumbo v2, ".kawarc.scm"
...
.method public static compileFiles([Ljava/lang/String;II)V
    ...
    const-string/jumbo v17, "(compiling "
...
.method static internalError(Ljava/lang/Throwable;Lgnu/expr/Compilation;Ljava/lang/Object;)V
    ...
    .end local v1    # "line":I
    :cond_0
    const-string/jumbo v3, "internal error while compiling "
...
.method public static processArgs([Ljava/lang/String;II)I
    ...
    const-string/jumbo v5, "unexpected end-of-file processing argument line for: \'"
    ...
    const-string/jumbo v5, " unused meta args"
    ...
    .line 415
    :cond_33
    const-string/jumbo v3, "--output-format"
    ...
    const-string/jumbo v3, "--connect port#"
    ...
    const-string/jumbo v5, "Listening on port "
    ...
    const-string/jumbo v5, "got connection from "
    ...
    .end local v31    # "port":I
    :cond_3c
    const-string/jumbo v3, "--http-auto-handler"
    ...
    const-string/jumbo v4, "kawa: HttpServer classes not found"
    ...
    .line 525
    :cond_3e
    const-string/jumbo v3, "--http-start"
    ...
    .line 529
    const-string/jumbo v3, "missing httpd port argument"
    ...
    .line 573
    :cond_43
    const-string/jumbo v3, "--debug-dump-zip"
    ...
    .line 575
    const-string/jumbo v3, "kawa-zip-dump-"
    ...
    .line 577
    :cond_44
    const-string/jumbo v3, "--debug-print-expr"
    ...
    .line 581
    :cond_45
    const-string/jumbo v3, "--debug-print-final-expr"
    ...
    .line 585
    :cond_46
    const-string/jumbo v3, "--debug-error-prints-stack-trace"
    ...
    .line 589
    :cond_47
    const-string/jumbo v3, "--debug-warning-prints-stack-trace"
    ...
    .line 593
    :cond_48
    const-string/jumbo v3, "--module-nonstatic"
    ...
    const-string/jumbo v3, "--no-module-static"
    ...
    .line 598
    :cond_4a
    const-string/jumbo v3, "--module-static"
    ...
    .line 602
    :cond_4b
    const-string/jumbo v3, "--module-static-run"
    ...
    .line 606
    :cond_4c
    const-string/jumbo v3, "--no-inline"
    ...
    const-string/jumbo v3, "--inline=none"
    ...
    .line 611
    :cond_4e
    const-string/jumbo v3, "--no-console"
    ...
    .line 622
    :cond_51
    const-string/jumbo v3, "--full-tailcalls"
    ...
    .line 627
    :cond_52
    const-string/jumbo v3, "--no-full-tailcalls"
    ...
    .line 632
    :cond_53
    const-string/jumbo v3, "--pedantic"
    ...
    const-string/jumbo v4, "Per Bothner <per@bothner.com>"
    ...
    const-string/jumbo v4, "Copyright (C) 2009 Per Bothner"
    ...
    const-string/jumbo v3, "unknown option name"
    ...
    const-string/jumbo v4, "both \'--no-\' prefix and \'="
    ...
    const-string/jumbo v4, "\' specified"
    ...
    const-string/jumbo v5, "kawa: bad option \'"
...
.method public static shouldUseGuiConsole()Z
    ...
    :cond_1
    :try_start_0
    const-string/jumbo v2, "java.lang.System"
