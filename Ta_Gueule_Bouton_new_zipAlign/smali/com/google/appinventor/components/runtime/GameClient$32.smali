...
.method public onFailure(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "Posting to server failed for "
...
.method public onSuccess(Lorg/json/JSONObject;)V
    ...
    .prologue
    .line 1136
    const-string/jumbo v3, "GameClient"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v5, "Received response for "
    ...
    const-string/jumbo v5, "Incorrect game id in response: + "
    ...
    const-string/jumbo v5, "Failed to parse JSON response to command "
    ...
    const-string/jumbo v5, "Ignored server response to "
    ...
    const-string/jumbo v5, " for incorrect instance "
