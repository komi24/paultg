...
.method private getAccountManagerResult(Landroid/app/Activity;Lcom/google/api/client/googleapis/auth/oauth2/GoogleCredential;Ljava/lang/String;Ljava/lang/String;)Landroid/accounts/AccountManagerFuture;
    ...
    const-string/jumbo v3, "Getting token by account"
    ...
    const-string/jumbo v3, "Getting token by features, possibly prompting user to select an account"
...
.method private persistCredentials(Landroid/content/SharedPreferences;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "Persisting credentials, acct ="
...
.method public static resetAccountCredential(Landroid/app/Activity;)V
    ...
    .prologue
    .line 212
    const-string/jumbo v2, "OAuthHelper"

    const-string/jumbo v3, "Reset credentials"
...
.method public getRefreshedAuthToken(Landroid/app/Activity;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 89
    const-string/jumbo v7, "OAuthHelper"

    const-string/jumbo v8, "getRefreshedAuthToken()"
    ...
    const-string/jumbo v8, "Can\'t get authtoken from UI thread"
    ...
    .line 122
    const-string/jumbo v7, "Error: operation cancelled"
    ...
    .line 125
    const-string/jumbo v7, "Error: Authenticator error"
    ...
    .line 128
    const-string/jumbo v7, "Error: I/O error"
