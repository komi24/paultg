...
.method private initializeTts()V
    ...
    .line 61
    const-string/jumbo v0, "InternalTTS"

    const-string/jumbo v1, "INTERNAL TTS is reinitializing"
...
.method private speak(Ljava/lang/String;Ljava/util/Locale;I)V
    ...
    .prologue
    .line 81
    const-string/jumbo v2, "InternalTTS"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "InternalTTS speak called, message = "
    ...
    const-string/jumbo v3, "max number of speak retries exceeded: speak will fail"
    ...
    const-string/jumbo v4, "TTS initialized after "
    ...
    const-string/jumbo v3, "speak called and tts.speak result was an error"
    ...
    const-string/jumbo v3, "speak called when TTS not initialized"
...
.method public onDestroy()V
    ...
    const-string/jumbo v1, "Internal TTS got onDestroy"
...
.method public onResume()V
    ...
    const-string/jumbo v1, "Internal TTS got onResume"
...
.method public speak(Ljava/lang/String;Ljava/util/Locale;)V
    ...
    const-string/jumbo v1, "Internal TTS got speak"
