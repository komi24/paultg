...
.method private static cacheMediaTempFile(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;)Ljava/io/File;
    ...
    const-string/jumbo v3, "Copying media "
    ...
    const-string/jumbo v3, " to temp file..."
    ...
    const-string/jumbo v3, "Finished copying media "
...
.method private static copyMediaToTempFile(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;)Ljava/io/File;
    ...
    const-string/jumbo v5, "Could not copy media "
    ...
    const-string/jumbo v5, " to temp file "
...
.method public static decodeSampledBitmapFromFile(Ljava/io/InputStream;Ljava/lang/String;II)Landroid/graphics/Bitmap;
    .locals 5
    .param p0, "is2"    # Ljava/io/InputStream;
    ...
    .line 585
    invoke-static {v0, p2, p3}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->calculateInSampleSize(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    const-string/jumbo v3, "decodeSampledBitmapFromFile sample size is:"
...
.method public static getBitmapDrawable(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    ...
    .prologue
    .line 426
    invoke-static {p0, p1}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->getBitmapDrawableCurrent(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
...
.method public static getBitmapDrawableCurrent(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    .locals 10
    .param p0, "form"    # Lcom/google/appinventor/components/runtime/Form;
    .param p1, "mediaPath"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
...
.method public static getBitmapDrawableNew(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Landroid/graphics/drawable/BitmapDrawable;
    .locals 21
    .param p0, "form"    # Lcom/google/appinventor/components/runtime/Form;
    .param p1, "mediaPath"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
    ...
    .line 344
    :cond_1
    invoke-static/range {p0 .. p1}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->determineMediaSource(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;

    move-result-object v9

    .line 345
    .local v9, "mediaSource":Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;
    const-string/jumbo v17, "MediaUtil"

    new-instance v18, Ljava/lang/StringBuilder;

    invoke-direct/range {v18 .. v18}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v19, "Media is of type: "

    invoke-virtual/range {v18 .. v19}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v18

    invoke-virtual {v9}, Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;->name()Ljava/lang/String;
    ...
    invoke-static {v0, v1, v9}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->openMedia(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;)Ljava/io/InputStream;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 364
    .local v7, "is1":Ljava/io/InputStream;
    const-string/jumbo v17, "MediaUtil"

    const-string/jumbo v18, "InputStream is1 was setup properly "
    ...
    invoke-static {v0, v7}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->getBitmapOptions(Lcom/google/appinventor/components/runtime/Form;Ljava/io/InputStream;)Landroid/graphics/BitmapFactory$Options;
    ...
    const-string/jumbo v18, "options from InputStream is1 was set"
    ...
    .line 375
    .local v8, "is2":Ljava/io/InputStream;
    const/4 v11, 0x0

    .line 377
    .local v11, "originalBitmapDrawable":Landroid/graphics/drawable/BitmapDrawable;
    :try_start_2
    ...
    invoke-static {v8, v0, v10}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->decodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 387
    .end local v11    # "originalBitmapDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .local v12, "originalBitmapDrawable":Landroid/graphics/drawable/BitmapDrawable;
    :try_start_3
    invoke-virtual/range {p0 .. p0}, Lcom/google/appinventor/components/runtime/Form;->deviceDensity()F

    move-result v16

    .line 388
    .local v16, "screenDensity":F
    ...
    const-string/jumbo v19, "scaled w, h are:"
    ...
    invoke-static {v8, v0, v15, v14}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->decodeSampledBitmapFromFile(Ljava/io/InputStream;Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v18, "scaledBitmapDrawable set up properly"
    ...
    .end local v7    # "is1":Ljava/io/InputStream;
    .end local v8    # "is2":Ljava/io/InputStream;
    .end local v10    # "options":Landroid/graphics/BitmapFactory$Options;
    .end local v12    # "originalBitmapDrawable":Landroid/graphics/drawable/BitmapDrawable;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/appinventor/components/runtime/Form;->getResources()Landroid/content/res/Resources;
    ...
    invoke-direct {v13, v0}, Landroid/graphics/drawable/BitmapDrawable;-><init>(Landroid/graphics/Bitmap;)V
    ...
    .restart local v7    # "is1":Ljava/io/InputStream;
    :catchall_0
    move-exception v17
    ...
    .line 403
    .restart local v8    # "is2":Ljava/io/InputStream;
    .restart local v10    # "options":Landroid/graphics/BitmapFactory$Options;
    .restart local v11    # "originalBitmapDrawable":Landroid/graphics/drawable/BitmapDrawable;
    :catch_1
    move-exception v6
    ...
    const-string/jumbo v19, "OutOfMemoryError exception for image: "
    ...
    .end local v11    # "originalBitmapDrawable":Landroid/graphics/drawable/BitmapDrawable;
    .restart local v12    # "originalBitmapDrawable":Landroid/graphics/drawable/BitmapDrawable;
    :catchall_2
    move-exception v17
...
.method public static getInputStream(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Ljava/io/InputStream;
    .locals 4
    .param p0, "form"    # Lcom/google/appinventor/components/runtime/Form;
    .param p1, "mediaPath"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
    ...
    .line 317
    .local v2, "mediaSource":Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;
    :try_start_0
    invoke-static {p0, p1, v2}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->openMedia(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;)Ljava/io/InputStream;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 319
    .local v0, "e":Ljava/io/IOException;
    sget-object v3, Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;->CONTACT_URI:Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;
...
.method public static getMediaFile(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Ljava/io/File;
    .locals 1
    .param p0, "form"    # Lcom/google/appinventor/components/runtime/Form;
    .param p1, "mediaPath"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
    ...
    .prologue
    .line 234
    invoke-static {p0, p1}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->copyMediaToTempFile(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Ljava/io/File;
...
.method public static getMediaFiles(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)[Ljava/lang/String;
    .locals 12
    .param p0, "form"    # Lcom/google/appinventor/components/runtime/Form;
    ...
    .line 765
    .local v8, "matchedFiles":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    invoke-static {p0, p1}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->determineMediaSource(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;
    ...
    .line 766
    .local v9, "mediaSource":Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;
    sget-object v10, Lcom/google/appinventor/components/runtime/util/MediaUtil$1;->$SwitchMap$com$google$appinventor$components$runtime$util$MediaUtil$MediaSource:[I

    invoke-virtual {v9}, Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;->ordinal()I
    ...
    .line 840
    .local v3, "arrayString":[Ljava/lang/String;
    return-object v3

    .line 768
    .end local v3    # "arrayString":[Ljava/lang/String;
    :pswitch_0
    ...
    const-string/jumbo v10, "/sdcard/AppInventor/assets/"
...
.method public static loadMediaPlayer(Landroid/media/MediaPlayer;Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)V
    ...
    const-string/jumbo v9, "Unable to load audio or video "
    ...
    const-string/jumbo v9, "Unable to load audio or video for contact "
...
.method public static loadSoundPool(Landroid/media/SoundPool;Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)I
    ...
    const-string/jumbo v4, "Unable to load audio "
    ...
    const-string/jumbo v4, "Unable to load audio for contact "
...
.method public static loadVideoView(Landroid/widget/VideoView;Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "Unable to load video "
    ...
    const-string/jumbo v4, "Unable to load video for contact "
...
.method private static openMedia(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;)Ljava/io/InputStream;
    ...
    const-string/jumbo v3, "Unable to open media "
    ...
    const-string/jumbo v3, "Unable to open contact photo "
...
.method public static readFile(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;)Ljava/lang/String;
    .locals 5
    .param p0, "form"    # Lcom/google/appinventor/components/runtime/Form;
    .param p1, "mediaPath"    # Ljava/lang/String;
    .annotation system Ldalvik/annotation/Throws;
    ...
    .line 252
    .local v2, "mediaSource":Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;
    invoke-static {p0, p1, v2}, Lcom/google/appinventor/components/runtime/util/MediaUtil;->copyMediaToTempFile(Lcom/google/appinventor/components/runtime/Form;Ljava/lang/String;Lcom/google/appinventor/components/runtime/util/MediaUtil$MediaSource;)Ljava/io/File;
