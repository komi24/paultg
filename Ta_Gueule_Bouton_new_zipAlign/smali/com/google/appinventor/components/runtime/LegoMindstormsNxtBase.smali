...
.method private handleError(Ljava/lang/String;I)V
    ...
    const-string/jumbo v4, "Error code 0x"
...
.method protected final convertMotorPortLetterToNumber(C)I
    ...
    const-string/jumbo v2, "Illegal motor port letter "
...
.method protected final convertSensorPortLetterToNumber(C)I
    ...
    const-string/jumbo v2, "Illegal sensor port letter "
...
.method protected final getInputValues(Ljava/lang/String;I)[B
    ...
    const-string/jumbo v4, " (expected 16)"
...
.method protected final getStatus(Ljava/lang/String;[BB)I
    ...
    const-string/jumbo v2, ": unexpected return package byte 0: 0x"
    ...
    const-string/jumbo v2, " (expected 0x02)"
    ...
    const-string/jumbo v2, ": unexpected return package byte 1: 0x"
    ...
    const-string/jumbo v2, " (expected 0x"
    ...
    const-string/jumbo v2, ": unexpected return package length "
    ...
    const-string/jumbo v2, " (expected >= 3)"
...
.method protected final lsGetStatus(Ljava/lang/String;I)I
    ...
    const-string/jumbo v5, " (expected 4)"
...
.method protected final lsRead(Ljava/lang/String;I)[B
    ...
    const-string/jumbo v4, " (expected 20)"
...
.method protected final lsWrite(Ljava/lang/String;I[BI)V
    ...
    const-string/jumbo v3, "length must be <= 16"
...
.method protected final sanitizePower(I)I
    ...
    const-string/jumbo v2, " is invalid, using -100."
...
.method protected final sanitizeTurnRatio(I)I
    ...
    const-string/jumbo v2, "turnRatio "
