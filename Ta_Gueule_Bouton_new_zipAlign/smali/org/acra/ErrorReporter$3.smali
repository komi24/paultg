...
.method public run()V
    ...
    const-string/jumbo v2, "Waiting for Toast + worker..."
    ...
    const-string/jumbo v2, "About to create DIALOG from #handleException"
    ...
    const-string/jumbo v3, "Wait for Toast + worker ended. Kill Application ? "
