...
.method public createCrashData(Ljava/lang/Throwable;ZLjava/lang/Thread;)Lorg/acra/collector/CrashReportData;
    ...
    const-string/jumbo v8, "acra.user.email"
    ...
    const-string/jumbo v7, "acra.deviceid.enable"
    ...
    const-string/jumbo v7, "acra.syslog.enable"
    ...
    const-string/jumbo v6, "android.permission.READ_LOGS"
    ...
    const-string/jumbo v7, "READ_LOGS granted! ACRA can include LogCat and DropBox data."
    ...
    const-string/jumbo v7, "Package info unavailable"
    ...
    const-string/jumbo v7, "Error while retrieving crash data"
    ...
    const-string/jumbo v7, "READ_LOGS not allowed. ACRA will not include LogCat and DropBox data."
    ...
    const-string/jumbo v8, "Error : application log file "
    ...
    const-string/jumbo v8, "Error while reading application log file "
