...
.method private deletePendingReports(ZZI)V
    ...
    const-string/jumbo v8, "Could not delete report : "
...
.method private handleException(Ljava/lang/Throwable;Lorg/acra/ReportingInteractionMode;ZZ)V
    ...
    const-string/jumbo v1, "Report requested by developer"
    ...
    const-string/jumbo v5, "acra.alwaysaccept"
    ...
    const-string/jumbo v5, "About to send status bar notification from #handleException"
...
.method private notifySendReport(Ljava/lang/String;)V
    ...
    .prologue
    .line 703
    iget-object v11, p0, Lorg/acra/ErrorReporter;->mContext:Landroid/content/Context;
    ...
    const-string/jumbo v13, "Creating Notification for "
    ...
    .line 720
    const-string/jumbo v11, "REPORT_FILE_NAME"
...
.method private saveCrashReportFile(Ljava/lang/String;Lorg/acra/collector/CrashReportData;)V
    ...
    const-string/jumbo v4, "Writing crash report file "
    ...
    const-string/jumbo v3, "An error occurred while writing the report file..."
...
.method public checkReportsOnApplicationStart()V
    ...
    const-string/jumbo v12, "About to start ReportSenderWorker from #checkReportOnApplicationStart"
...
.method public handleSilentException(Ljava/lang/Throwable;)V
    ...
    const-string/jumbo v1, "ACRA sent Silent report."
    ...
    const-string/jumbo v1, "ACRA is disabled. Silent report not sent."
...
.method notifyDialog(Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "Creating Dialog for "
...
.method public setDefaultReportSenders()V
    ...
    const-string/jumbo v5, " reports will be sent by email (if accepted by user)."
    ...
    const-string/jumbo v5, " should be granted permission "
    ...
    const-string/jumbo v5, " if you want your crash reports to be sent. If you don\'t want to add this permission to your application you can also enable sending reports by email. If this is your will then provide your email address in @ReportsCrashes(mailTo=\"your.account@domain.com\""
...
.method public uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    const-string/jumbo v3, "ACRA is disabled for "
    ...
    const-string/jumbo v3, " - forwarding uncaught Exception on to default ExceptionHandler"
    ...
    const-string/jumbo v3, " - no default ExceptionHandler"
    ...
    const-string/jumbo v3, "ACRA caught a "
    ...
    const-string/jumbo v3, " exception for "
