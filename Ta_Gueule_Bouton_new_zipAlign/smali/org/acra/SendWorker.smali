...
.method private approvePendingReports()V
    ...
    const-string/jumbo v10, "Mark all pending reports as approved."
    ...
    const-string/jumbo v11, "Could not rename approved report from "
...
.method private checkAndSendReports(Landroid/content/Context;Z)V
    ...
    const-string/jumbo v11, "#checkAndSendReports - start"
    ...
    const-string/jumbo v11, "#checkAndSendReports - finish"
    ...
    const-string/jumbo v12, "Sending file "
    ...
    const-string/jumbo v12, "Failed to send crash reports for "
    ...
    const-string/jumbo v12, "Failed to load crash report for "
    ...
    const-string/jumbo v12, "Failed to send crash report for "
...
.method private deleteFile(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "Could not delete error report : "
...
.method private sendCrashReport(Lorg/acra/collector/CrashReportData;)V
    ...
    const-string/jumbo v6, "ReportSender of class "
    ...
    const-string/jumbo v6, " failed but other senders completed their task. ACRA will not send this report again."
