...
.method private getHttpClient()Lorg/apache/http/client/HttpClient;
    ...
    const-string/jumbo v5, "http.protocol.cookie-policy"
...
.method private getHttpPost(Ljava/net/URL;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpPost;
    ...
    const-string/jumbo v4, "text/html,application/xml,application/xhtml+xml,text/html;q=0.9,text/plain;q=0.8,image/png,*/*;q=0.5"
...
.method public sendPost(Ljava/net/URL;Ljava/util/Map;)V
    ...
    const-string/jumbo v9, "Sending request to "
    ...
    const-string/jumbo v8, "Host returned error code "
