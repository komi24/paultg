...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v1, "line-length"
    ...
    const-string/jumbo v1, "miser-width"
...
.method public constructor <init>(Ljava/io/Writer;I)V
    ...
    iput v1, p0, Lgnu/text/PrettyWriter;->lineLength:I

    .line 40
    const/16 v1, 0x28

    iput v1, p0, Lgnu/text/PrettyWriter;->miserWidth:I

    .line 81
    sget v1, Lgnu/text/PrettyWriter;->initialBufferSize:I
    ...
    iput-object v1, p0, Lgnu/text/PrettyWriter;->suffix:[C
    ...
    iput-object v1, p0, Lgnu/text/PrettyWriter;->queueStrings:[Ljava/lang/String;

    .line 177
    const/4 v1, -0x1

    iput v1, p0, Lgnu/text/PrettyWriter;->currentBlock:I
...
.method private static enoughSpace(II)I
    ...
    .end local v0    # "doubled":I
    :goto_0
    return v0

    .restart local v0    # "doubled":I
    :cond_0
    move v0, v1
...
.method public enqueueNewline(I)V
    ...
    iget v10, p0, Lgnu/text/PrettyWriter;->pendingBlocksCount:I
    ...
    :goto_1
    invoke-virtual {p0, v7, v8}, Lgnu/text/PrettyWriter;->maybeOutput(ZZ)Z
...
.method expandTabs(I)V
    ...
    iget v9, v0, Lgnu/text/PrettyWriter;->bufferStartColumn:I
    ...
    iget v12, v0, Lgnu/text/PrettyWriter;->bufferFillPointer:I
    ...
    iget-object v8, v0, Lgnu/text/PrettyWriter;->buffer:[C
    ...
    invoke-static {v8, v0, v1, v10, v2}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-static {v8, v0, v1, v2, v11}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
...
.method maybeOutput(ZZ)Z
    ...
    iget v9, v0, Lgnu/text/PrettyWriter;->queueTail:I

    .line 903
    .local v9, "next":I
    move-object/from16 v0, p0

    invoke-direct {v0, v9}, Lgnu/text/PrettyWriter;->getQueueType(I)I
    ...
    invoke-virtual {v0, v3, v1}, Lgnu/text/PrettyWriter;->fitsOnLine(IZ)I
    ...
    invoke-virtual {v0, v9}, Lgnu/text/PrettyWriter;->outputLine(I)V
    :try_end_1
    ...
    invoke-virtual {v0, v7}, Lgnu/text/PrettyWriter;->setIndentation(I)V
    ...
    invoke-virtual {v0, v9}, Lgnu/text/PrettyWriter;->expandTabs(I)V

    .line 988
    move-object/from16 v0, p0

    iput v9, v0, Lgnu/text/PrettyWriter;->queueTail:I
    ...
    invoke-virtual {v0, v1, v11, v14}, Lgnu/text/PrettyWriter;->reallyStartLogicalBlock(ILjava/lang/String;Ljava/lang/String;)V
...
.method outputLine(I)V
    ...
    iget-object v6, v0, Lgnu/text/PrettyWriter;->buffer:[C
    ...
    invoke-virtual {v0, v6, v1, v5}, Ljava/io/Writer;->write([CII)V

    .line 1099
    move-object/from16 v0, p0

    iget v13, v0, Lgnu/text/PrettyWriter;->lineNumber:I
    ...
    invoke-virtual/range {v21 .. v22}, Ljava/io/Writer;->write(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v21 .. v22}, Ljava/io/Writer;->write(I)V
    ...
    .line 1126
    .local v16, "newFillPtr":I
    move-object v15, v6

    .line 1127
    .local v15, "newBuffer":[C
    array-length v7, v6
    ...
    invoke-static {v7, v0}, Lgnu/text/PrettyWriter;->enoughSpace(II)I
    ...
    iput-object v15, v0, Lgnu/text/PrettyWriter;->buffer:[C
    ...
    invoke-static {v6, v4, v15, v0, v1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    .line 1076
    .end local v4    # "amountToConsume":I
    .end local v5    # "amountToPrint":I
    .end local v7    # "bufferLength":I
    .end local v8    # "fillPtr":I
    .end local v10    # "isLiteral":Z
    .end local v13    # "lineNumber":I
    .end local v15    # "newBuffer":[C
    .end local v16    # "newFillPtr":I
    .end local v17    # "prefixLen":I
    ...
    .line 1084
    .restart local v4    # "amountToConsume":I
    .restart local v10    # "isLiteral":Z
    :cond_5
    move v9, v4
    ...
    .line 1089
    .restart local v5    # "amountToPrint":I
    goto/16 :goto_1
...
.method outputPartialLine()V
    ...
    const-string/jumbo v7, "outputPartialLine called when nothing can be output."
...
.method reallyStartLogicalBlock(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v0, v9, v1, v5}, Ljava/lang/String;->getChars(II[CI)V
    ...
    invoke-static {v10, v0, v1, v5, v4}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
...
.method public startLogicalBlock(Ljava/lang/String;ZLjava/lang/String;)V
    ...
    .line 627
    sget-object v5, Lgnu/text/PrettyWriter;->lineLengthLoc:Lgnu/mapping/ThreadLocation;
    ...
    iput v5, p0, Lgnu/text/PrettyWriter;->lineLength:I

    .line 633
    :goto_0
    sget-object v5, Lgnu/text/PrettyWriter;->miserWidthLoc:Lgnu/mapping/ThreadLocation;
    ...
    iput v5, p0, Lgnu/text/PrettyWriter;->miserWidth:I

    .line 641
    :goto_1
    sget-object v5, Lgnu/text/PrettyWriter;->indentLoc:Lgnu/mapping/ThreadLocation;
    ...
    .line 646
    :cond_2
    iget v5, p0, Lgnu/text/PrettyWriter;->prettyPrintingMode:I
    ...
    invoke-virtual {p0, v5, v6}, Lgnu/text/PrettyWriter;->enqueue(II)I
    ...
    iget v7, p0, Lgnu/text/PrettyWriter;->pendingBlocksCount:I

    aput v7, v5, v6

    .line 651
    iget-object v5, p0, Lgnu/text/PrettyWriter;->queueStrings:[Ljava/lang/String;
