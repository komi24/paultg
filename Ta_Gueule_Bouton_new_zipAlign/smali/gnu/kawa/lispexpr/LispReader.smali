...
.method static getReadCase()C
    ...
    const-string/jumbo v4, "symbol-read-case"
...
.method public static parseNumber([CIICII)Ljava/lang/Object;
    ...
    .line 501
    const-string/jumbo v16, "no digits"
    ...
    .line 556
    const-string/jumbo v16, "duplicate radix specifier"
    ...
    .line 535
    const-string/jumbo v16, "non-prefix exactness specifier"

    goto :goto_0

    .line 537
    :cond_8
    const-string/jumbo v16, "duplicate exactness specifier"
    ...
    .line 550
    const-string/jumbo v16, "missing letter after \'#\'"
    ...
    .line 558
    :cond_d
    const-string/jumbo v16, "invalid radix specifier"
    ...
    const-string/jumbo v5, "unknown modifier \'#"
    ...
    .line 595
    const-string/jumbo v16, "no digits following sign"
    ...
    .line 627
    const-string/jumbo v16, "digit after \'#\' in number"
    ...
    .line 652
    const-string/jumbo v16, "duplicate \'.\' in number"
    ...
    .line 654
    const-string/jumbo v16, "\'.\' in non-decimal number"
    ...
    .line 670
    :cond_2b
    const-string/jumbo v16, "missing exponent digits"
    ...
    .line 678
    const-string/jumbo v16, "duplicate exponent"
    ...
    .line 680
    const-string/jumbo v16, "exponent in non-decimal number"
    ...
    .line 682
    const-string/jumbo v16, "mantissa with no digits"
    ...
    .line 692
    const-string/jumbo v16, "multiple fraction symbol \'/\'"
    ...
    .line 694
    const-string/jumbo v16, "no digits before fraction symbol \'/\'"
    ...
    .line 696
    :cond_34
    const-string/jumbo v16, "fraction symbol \'/\' following exponent or \'.\'"
    ...
    .line 821
    const-string/jumbo v16, "invalid complex polar constant"
    ...
    .line 760
    const-string/jumbo v16, "floating-point number after fraction symbol \'/\'"
    ...
    .line 792
    const-string/jumbo v16, "0/0 is undefined"
    ...
    const-string/jumbo v5, "invalid numeric constant ("
    ...
    .line 843
    const-string/jumbo v16, "invalid numeric constant"
    ...
    .line 867
    const-string/jumbo v16, "junk after imaginary suffix \'i\'"
    ...
    .end local v44    # "prev":C
    :cond_5a
    const-string/jumbo v16, "excess junk after number"
...
.method public static readCharacter(Lgnu/kawa/lispexpr/LispReader;)Ljava/lang/Object;
    ...
    .line 1152
    const-string/jumbo v8, "unexpected EOF in character literal"
    ...
    const-string/jumbo v9, "unknown character name: "
...
.method public static readNumberWithRadix(ILgnu/kawa/lispexpr/LispReader;I)Ljava/lang/Object;
    ...
    .line 1128
    const-string/jumbo v0, "missing numeric token"
    ...
    .line 1140
    const-string/jumbo v0, "invalid numeric constant"
...
.method public static readSimpleVector(Lgnu/kawa/lispexpr/LispReader;C)Lgnu/lists/SimpleVector;
    ...
    .line 1252
    const-string/jumbo v7, "unexpected EOF reading uniform vector"
    ...
    .line 1262
    :cond_3
    const-string/jumbo v7, "invalid uniform vector syntax"
    ...
    .line 1269
    const-string/jumbo v7, "invalid elements in uniform vector syntax"
...
.method public static readSpecial(Lgnu/kawa/lispexpr/LispReader;)Ljava/lang/Object;
    ...
    .line 1203
    const-string/jumbo v5, "unexpected EOF in #! special form"
    ...
    .line 1234
    :cond_9
    const-string/jumbo v5, "abstract"
    ...
    const-string/jumbo v6, "unknown named constant #!"
...
.method protected readAndHandleToken(IILgnu/kawa/lispexpr/ReadTable;)Ljava/lang/Object;
    ...
    .line 239
    const-string/jumbo v3, "expected identifier in symbol after \'{URI}:\'"
...
.method public readEscape()I
    ...
    .line 914
    const-string/jumbo v1, "unexpected EOF in character literal"
...
.method public final readEscape(I)I
    ...
    .line 943
    const-string/jumbo v4, "unexpected EOF in literal"
    ...
    .line 983
    const-string/jumbo v5, "Invalid escape character syntax"
    ...
    .line 1035
    const-string/jumbo v4, "premature EOF in \\u escape"
    ...
    .line 1038
    const-string/jumbo v4, "non-hex character following \\u"
...
.method public final readNestedComment(CC)V
    ...
    const-string/jumbo v5, "unexpected end-of-file in "
    ...
    const-string/jumbo v5, " comment starting here"
...
.method readToken(ICLgnu/kawa/lispexpr/ReadTable;)V
    ...
    .line 276
    const-string/jumbo v6, "unexpected EOF between escapes"
    ...
    .line 314
    const-string/jumbo v6, "unexpected EOF after single escape"
...
.method public readValues(ILgnu/kawa/lispexpr/ReadTableEntry;Lgnu/kawa/lispexpr/ReadTable;)Ljava/lang/Object;
    ...
    const-string/jumbo v4, "invalid character #\\"
