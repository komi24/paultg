...
.method public addAll(Lgnu/lists/FString;)Z
    ...
    iget v3, p1, Lgnu/lists/FString;->size:I
    ...
    .line 241
    :cond_0
    iget-object v2, p1, Lgnu/lists/FString;->data:[C

    iget-object v3, p0, Lgnu/lists/FString;->data:[C

    iget v4, p0, Lgnu/lists/FString;->size:I

    iget v5, p1, Lgnu/lists/FString;->size:I
...
.method public addAll(Ljava/lang/CharSequence;)Z
    ...
    iget-object v4, p1, Lgnu/lists/FString;->data:[C

    iget-object v5, p0, Lgnu/lists/FString;->data:[C

    iget v6, p0, Lgnu/lists/FString;->size:I
    ...
    invoke-virtual {p1, v3, v2, v4, v5}, Ljava/lang/String;->getChars(II[CI)V
    ...
    invoke-interface {p1, v3, v2, v4, v5}, Lgnu/lists/CharSeq;->getChars(II[CI)V
...
.method public compareTo(Ljava/lang/Object;)I
    ...
    check-cast v9, Lgnu/lists/FString;

    .line 421
    .local v9, "str2":Lgnu/lists/FString;
    iget-object v2, p0, Lgnu/lists/FString;->data:[C

    .line 422
    .local v2, "cs1":[C
    iget-object v3, v9, Lgnu/lists/FString;->data:[C

    .line 423
    .local v3, "cs2":[C
    iget v7, p0, Lgnu/lists/FString;->size:I

    .line 424
    .local v7, "n1":I
    iget v8, v9, Lgnu/lists/FString;->size:I
...
.method public writeTo(IILjava/lang/Appendable;)V
    ...
    .end local p3    # "dest":Ljava/lang/Appendable;
    iget-object v1, p0, Lgnu/lists/FString;->data:[C
    ...
    .restart local p3    # "dest":Ljava/lang/Appendable;
    :cond_0
    add-int v1, p1, p2
