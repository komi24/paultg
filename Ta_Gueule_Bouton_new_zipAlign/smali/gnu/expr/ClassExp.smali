...
.method static invokeDefaultSuperConstructor(Lgnu/bytecode/ClassType;Lgnu/expr/Compilation;Lgnu/expr/LambdaExp;)V
    ...
    const-string/jumbo v5, "super class does not have a default constructor"
...
.method public compileMembers(Lgnu/expr/Compilation;)Lgnu/bytecode/ClassType;
    ...
    iget-object v12, v0, Lgnu/expr/LambdaExp;->type:Lgnu/bytecode/ClassType;
    ...
    invoke-virtual {v0, v12}, Lgnu/bytecode/ClassType;->setEnclosingMember(Lgnu/bytecode/Member;)V

    .line 446
    instance-of v0, v12, Lgnu/bytecode/ClassType;
    ...
    invoke-virtual {v12, v0}, Lgnu/bytecode/ClassType;->addMemberClass(Lgnu/bytecode/ClassType;)V
    ...
    invoke-virtual {v0, v14}, Lgnu/bytecode/ClassType;->setSourceFile(Ljava/lang/String;)V
    ...
    iget-object v9, v0, Lgnu/expr/ClassExp;->firstChild:Lgnu/expr/LambdaExp;
    ...
    invoke-virtual {v0, v9}, Lgnu/expr/Compilation;->setLine(Lgnu/expr/Expression;)V
    ...
    invoke-virtual {v9, v0}, Lgnu/expr/LambdaExp;->declareThis(Lgnu/bytecode/ClassType;)Lgnu/bytecode/Variable;
    ...
    iput-object v9, v0, Lgnu/expr/Compilation;->curLambda:Lgnu/expr/LambdaExp;
    ...
    invoke-virtual {v9, v0}, Lgnu/expr/LambdaExp;->allocChildClasses(Lgnu/expr/Compilation;)V

    .line 490
    move-object/from16 v0, p1

    invoke-virtual {v9, v0}, Lgnu/expr/LambdaExp;->allocParameters(Lgnu/expr/Compilation;)V

    .line 491
    const-string/jumbo v44, "*init*"
    ...
    invoke-virtual {v11, v0}, Lgnu/bytecode/CodeAttr;->emitPutField(Lgnu/bytecode/Field;)V
    ...
    :goto_3
    instance-of v0, v6, Lgnu/expr/BeginExp;
    ...
    iget v0, v5, Lgnu/expr/BeginExp;->length:I
    ...
    .line 510
    :cond_b
    iget-object v0, v5, Lgnu/expr/BeginExp;->exps:[Lgnu/expr/Expression;
    ...
    instance-of v0, v6, Lgnu/expr/ApplyExp;
    ...
    invoke-virtual {v6, v0, v1}, Lgnu/expr/Expression;->compileWithPosition(Lgnu/expr/Compilation;Lgnu/expr/Target;)V
    ...
    const-string/jumbo v45, "call to <init> for not this or super class"
    ...
    invoke-virtual {v9, v0}, Lgnu/expr/LambdaExp;->enterFunction(Lgnu/expr/Compilation;)V
    ...
    .line 544
    iget-object v0, v9, Lgnu/expr/LambdaExp;->body:Lgnu/expr/Expression;
    ...
    invoke-virtual {v9, v0}, Lgnu/expr/LambdaExp;->compileEnd(Lgnu/expr/Compilation;)V

    .line 554
    move-object/from16 v0, p1

    invoke-virtual {v9, v0}, Lgnu/expr/LambdaExp;->generateApplyMethods(Lgnu/expr/Compilation;)V
    ...
    invoke-virtual {v9, v0}, Lgnu/expr/LambdaExp;->compileBody(Lgnu/expr/Compilation;)V
    ...
    const-string/jumbo v45, "unimplemented: explicit constructor cannot initialize "
    ...
    const-string/jumbo v25, "missing implementation for "
    ...
    :cond_1e
    const-string/jumbo v25, "ambiguous implementation for "
...
.method public compilePushClass(Lgnu/expr/Compilation;Lgnu/expr/Target;)V
    ...
    .line 101
    :goto_1
    const-string/jumbo v8, "gnu.expr.PairClassType"
    ...
    .line 115
    :cond_2
    const-string/jumbo v8, "java.lang.Class"
    ...
    .end local v7    # "typeType":Lgnu/bytecode/ClassType;
    :cond_5
    const-string/jumbo v8, "gnu.bytecode.Type"
...
.method public setTypes(Lgnu/expr/Compilation;)V
    ...
    const-string/jumbo v23, "invalid super type"
    ...
    const-string/jumbo v24, "duplicate superclass for "
    ...
    const-string/jumbo v24, "unknown super-type "
    ...
    const-string/jumbo v23, "cannot be interface since has superclass"
