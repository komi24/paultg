...
.method public static main([Ljava/lang/String;)V
    ...
    .prologue
    .line 504
    new-instance v3, Lkawa/standard/Scheme;

    invoke-direct {v3}, Lkawa/standard/Scheme;-><init>()V
    ...
    instance-of v8, v2, Lgnu/mapping/TtyInPort;

    if-eqz v8, :cond_0

    .line 509
    new-instance v6, Lgnu/ecmascript/Prompter;

    invoke-direct {v6}, Lgnu/ecmascript/Prompter;-><init>()V

    .local v6, "prompter":Lgnu/ecmascript/Prompter;
    move-object v8, v2

    .line 510
    check-cast v8, Lgnu/mapping/TtyInPort;

    check-cast v6, Lgnu/mapping/Procedure;

    .end local v6    # "prompter":Lgnu/ecmascript/Prompter;
    invoke-virtual {v8, v6}, Lgnu/mapping/TtyInPort;->setPrompter(Lgnu/mapping/Procedure;)V

    .line 513
    :cond_0
    new-instance v5, Lgnu/ecmascript/Parser;

    invoke-direct {v5, v2}, Lgnu/ecmascript/Parser;-><init>(Lgnu/mapping/InPort;)V

    .line 514
    .local v5, "parser":Lgnu/ecmascript/Parser;
    ...
    .line 533
    .restart local v1    # "expr":Lgnu/expr/Expression;
    :cond_1
    const-string/jumbo v8, "[Expression: "

    invoke-virtual {v4, v8}, Lgnu/mapping/OutPort;->print(Ljava/lang/String;)V

    .line 534
    invoke-virtual {v1, v4}, Lgnu/expr/Expression;->print(Lgnu/mapping/OutPort;)V

    .line 535
    const-string/jumbo v8, "]"

    invoke-virtual {v4, v8}, Lgnu/mapping/OutPort;->println(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v8}, Lgnu/expr/Expression;->eval(Lgnu/mapping/Environment;)Ljava/lang/Object;
    ...
    .line 538
    invoke-virtual {v4, v7}, Lgnu/mapping/OutPort;->print(Ljava/lang/Object;)V
...
.method public buildLoop(Lgnu/expr/Expression;Lgnu/expr/Expression;Lgnu/expr/Expression;Lgnu/expr/Expression;)Lgnu/expr/Expression;
    ...
    const-string/jumbo v2, "not implemented - buildLoop"
...
.method public getIdentifier()Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo v1, "missing identifier"
...
.method public getSemicolon()V
    ...
    .line 155
    const-string/jumbo v0, "missing \';\' after expression"
...
.method public parseArguments()[Lgnu/expr/Expression;
    ...
    .line 193
    sget-object v2, Lgnu/ecmascript/Parser;->emptyArgs:[Lgnu/expr/Expression;
    ...
    const-string/jumbo v5, "\' in argument list"
...
.method public parseAssignmentExpression()Lgnu/expr/Expression;
    ...
    sget-object v6, Lgnu/ecmascript/Lexer;->equalToken:Lgnu/text/Char;
    ...
    instance-of v6, v1, Lgnu/expr/ReferenceExp;
    ...
    invoke-direct {v4, v6, v2}, Lgnu/expr/SetExp;-><init>(Ljava/lang/Object;Lgnu/expr/Expression;)V

    .line 51
    .local v4, "sex":Lgnu/expr/SetExp;
    invoke-virtual {v4, v7}, Lgnu/expr/SetExp;->setDefining(Z)V
    ...
    .restart local v2    # "exp2":Lgnu/expr/Expression;
    :cond_1
    const-string/jumbo v6, "unmplemented non-symbol ihs in assignment"
    ...
    .end local v2    # "exp2":Lgnu/expr/Expression;
    :cond_2
    instance-of v6, v5, Lgnu/ecmascript/Reserved;
    ...
    invoke-virtual {v3}, Lgnu/ecmascript/Reserved;->isAssignmentOp()Z
    ...
    iget-object v7, v3, Lgnu/ecmascript/Reserved;->proc:Lgnu/mapping/Procedure;

    invoke-direct {v6, v7}, Lgnu/expr/QuoteExp;-><init>(Ljava/lang/Object;)V

    invoke-direct {v1, v6, v0}, Lgnu/expr/ApplyExp;-><init>(Lgnu/expr/Expression;[Lgnu/expr/Expression;)V
...
.method public parseConditionalExpression()Lgnu/expr/Expression;
    ...
    .line 31
    .restart local v0    # "exp1":Lgnu/expr/Expression;
    :cond_0
    invoke-virtual {p0}, Lgnu/ecmascript/Parser;->skipToken()V
    ...
    .line 34
    const-string/jumbo v4, "expected \':\' in conditional expression"
...
.method public parseExpression()Lgnu/expr/Expression;
    ...
    sget-object v9, Lgnu/ecmascript/Lexer;->commaToken:Lgnu/text/Char;
...
.method public parseFunctionDefinition()Lgnu/expr/Expression;
    ...
    const-string/jumbo v8, "expected \'(\' - got:"
    ...
    const-string/jumbo v8, "invalid token \'"
    ...
    const-string/jumbo v8, "\' in argument list"
...
.method public parseIfStatement()Lgnu/expr/Expression;
    ...
    const-string/jumbo v5, "expected \'(\' - got:"
...
.method public parseLeftHandSideExpression()Lgnu/expr/Expression;
    ...
    const-string/jumbo v8, "after parseArgs:"
...
.method public parsePostfixExpression()Lgnu/expr/Expression;
    ...
    .end local v2    # "op":Ljava/lang/Object;
    iget-object v4, v2, Lgnu/ecmascript/Reserved;->proc:Lgnu/mapping/Procedure;

    invoke-direct {v3, v4}, Lgnu/expr/QuoteExp;-><init>(Ljava/lang/Object;)V

    invoke-direct {v1, v3, v0}, Lgnu/expr/ApplyExp;-><init>(Lgnu/expr/Expression;[Lgnu/expr/Expression;)V
...
.method public parsePrimaryExpression()Lgnu/expr/Expression;
    ...
    const-string/jumbo v4, "expected \')\' - got:"
