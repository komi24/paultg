...
.method public static main([Ljava/lang/String;)V
    ...
    const-string/jumbo v24, "-verbose"
    ...
    const-string/jumbo v25, "File for URL "
    ...
    const-string/jumbo v25, "Jar File for URL "
    ...
    const-string/jumbo v25, "Error opening zip archive "
    ...
    const-string/jumbo v25, "Can\'t find .class file for class "
...
.method public static process(Ljava/io/InputStream;Ljava/lang/String;Lgnu/bytecode/ClassTypeWriter;)V
    ...
    .line 96
    const-string/jumbo v5, "Reading .class from "
    ...
    .line 104
    const-string/jumbo v5, "Reading classes from archive "
    ...
    .line 114
    const-string/jumbo v5, "Archive directory: "
    ...
    .line 124
    const-string/jumbo v5, "Reading class member: "
    ...
    .line 131
    :cond_2
    const-string/jumbo v5, "Skipping non-class member: "
    ...
    const-string/jumbo v7, " is not a valid .class file"
...
.method public static usage(Ljava/io/PrintStream;)V
    ...
    .prologue
    .line 360
    const-string/jumbo v0, "Prints and dis-assembles the contents of JVM .class files."

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 361
    const-string/jumbo v0, "Usage: [--verbose] class-or-jar ..."

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 362
    const-string/jumbo v0, "where a class-or-jar can be one of:"

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 363
    const-string/jumbo v0, "- a fully-qualified class name; or"

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 364
    const-string/jumbo v0, "- the name of a .class file, or a URL reference to one; or"

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 365
    const-string/jumbo v0, "- the name of a .jar or .zip archive file, or a URL reference to one."

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 366
    const-string/jumbo v0, "If a .jar/.zip archive is named, all its.class file members are printed."
    ...
    .line 368
    const-string/jumbo v0, "You can name a single .class member of an archive with a jar: URL,"

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 369
    const-string/jumbo v0, "which looks like: jar:jar-spec!/p1/p2/cl.class"

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 370
    const-string/jumbo v0, "The jar-spec can be a URL or the name of the .jar file."

    invoke-virtual {p0, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 371
    const-string/jumbo v0, "You can also use the shorthand syntax: jar:jar-spec!p1.p2.cl"
